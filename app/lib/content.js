...
export const capabilities = [
  {
    ...
    tagline: "Turns half-formed ideas into something real.",
    description:
      "Kai turns loose product ideas into a clear next version: what to build, what to skip, what needs testing, and what can ship now.",
    proof: "Roadmaps, decisions, and launches with an owner.",
    shape: "blade",
  },
  {
    key: "systems",
    short: "Systems",
    category: "Systems & Handoffs",
    tagline: "Follows the weird break until it makes sense.",
    description:
      "Kai connects the dots between your website, data, tools, team process, and customer experience so fixes do not create new messes somewhere else.",
    proof: "Clear priorities across tools, people, and tech.",
    shape: "driver",
  },
  {
    key: "infra",
    ...
    tagline: "Keeps the boring parts boring.",
    description:
      "Practical AWS, Linux, release, monitoring, and cost cleanup. The goal is simple: fewer surprises and a setup people can actually maintain.",
    proof: "Reliability, monitoring, and cloud spend kept visible.",
    shape: "saw",
  },
  {
    key: "commerce",
    ...
    tagline: "Makes buying feel obvious.",
    description:
      "Kai looks at the whole buying path: storefront speed, app sprawl, checkout friction, tracking, fulfillment handoffs, and the small misses that add up.",
    proof: "Cleaner commerce flows and fewer blind spots.",
    shape: "hook",
  },
  {
    key: "ai",
  ...
  },
  {
    ...
    tagline: "Turns fuzzy numbers into decisions.",
    description:
      "Kai cleans up tracking, funnels, landing pages, and follow-up so you can see what is helping, what is noise, and where the next fix belongs.",
    proof: "Cleaner numbers tied to what is actually making money.",
    shape: "scissors",
  },
  {
    key: "brand",
    ...
    tagline: "Makes the outside match the real business.",
    description:
      "Kai helps make the offer, copy, visuals, and product promise feel clear, believable, and aligned with what the business can actually deliver.",
    proof: "Positioning grounded in what is real.",
    shape: "opener",
  },
];
...
export const packages = [
  {
    ...
    pathOutcome: "Find where brand trust, website, calls, forms, ordering, and follow-up are losing momentum.",
    board: {
      problem: "The brand says one thing, the website another, and the follow-up tools make it hard to see what is working.",
      move: "Trace the customer path, pressure-test the brand, and rank the fixes by business impact.",
      outcome: "A short decision-ready plan: what to fix, what to leave alone, and what to build next.",
    },
    animation: "find",
    summary:
      "A practical audit for established businesses whose brand, website, store, or lead flow is not keeping up with the quality of the real business.",
    includes: [
      "Brand trust, website, tracking, forms, checkout, search, speed, and follow-up review",
      "Lead, order, and follow-up gaps mapped clearly",
  ...
  },
  {
    ...
    pathOutcome: "Clean up the highest-impact brand, conversion, or workflow issue instead of wandering through a giant wish list.",
    board: {
      problem: "One high-friction part of the digital flow is costing leads, orders, trust, or team time.",
      move: "Scope one tight outcome and fix the copy, page, form, tracking, automation, or handoff.",
      outcome: "A visible improvement ships without turning into a giant rebuild.",
    },
    animation: "fix",
    summary:
      "A 1-2 week sprint to clean up the digital issues already costing the business leads, orders, time, or trust.",
    includes: [
      "Fixes for copy, landing pages, forms, tracking, Shopify/app sprawl, speed, or automations",
      "One tight outcome, scoped before work begins",
  ...
  },
  {
    ...
    board: {
      ...
      outcome: "A brand and digital layer that finally feels like the real business.",
    },
    animation: "build",
    summary:
  ...
  },
  {
    ...
    pathOutcome: "Keep the brand and digital pieces maintained, measured, and improving after launch.",
    board: {
      problem: "After launch, small digital decisions pile up until the brand, tools, and tracking drift apart.",
      move: "Keep an eye on tracking, content, updates, automations, and platform decisions.",
      outcome: "A steady operating loop without hiring a full internal team.",
    },
    animation: "run",
    summary:
      "Ongoing care for the digital pieces that keep getting ignored until something drifts, breaks, or starts costing money.",
    includes: [
      "Three-month minimum, often after a build or sprint",
      "Maintenance, content updates, tracking checks, and small improvements",
...
export const about = {
  ...
  signals: [
    ...
    },
    {
      ...
      text: "Clear choices, useful taste, and the patience to keep pushing until the finished thing feels like the business finally caught up.",
    },
    {
      label: "Human pace",
      text: "Friendly, direct, and easy to talk to. Serious about the work without making every conversation feel like a status meeting.",
    },
  ],
};
...
export const caseStudies = [
  {
    ...
    name: "Founder-led DTC brand",
    sector: "Shopify Plus / commerce operations",
    problem:
      "The founder had a real business, a busy team, and too many opinions. Mobile speed, app overlap, shaky tracking, and release risk were all tangled together.",
    built: [
      "Separated urgent revenue issues from cosmetic work",
      "Cut app and script overlap without breaking ops",
      "Restored trust in checkout and server-side tracking",
      "Gave the team a cleaner release path",
    ],
    metric: "+18%",
  ...
  },
  {
    ...
    metric: "7.5 hrs",
    label: "saved per reviewer per week",
    note: "Pilot across 9 reviewers / median first review 6h to 55min",
  },
  {
    tag: "Product / Infrastructure",
    name: "Seed-stage marketplace",
    sector: "Product system / investor diligence",
    problem:
      "The founder needed to move from a convincing story to a pilot-ready product: enough product, infrastructure, and usage signal to show real traction.",
    built: [
      "Sequenced the pilot around product risk",
      "Set the infrastructure and release path",
      "Added logging and basic product analytics",
      "Created admin and onboarding flows for real customer pilots",
    ],
    metric: "3",
    label: "pilot customers signed",
    note: "99.9% uptime during pilot window / usage data supported seed diligence",
  },
];
